...
(function($, window, document, undefined) {
    ...
    function init(target, options) {
		...
		//初始化各个组件
        var $msb_main = "<a class='msb_main'><img title='分享' src='/4g/template/images/share_core_square.jpg'></a>";
   ...
   // var tqq='http://sns.qzone.qq.com/cgi-bin/qzshare/cgi_qzshare_onekey?url={url}&title={title}';
